...
create table if not exists "user" ("first_name" VARCHAR(254),"last_name" VARCHAR(254),"user_name" VARCHAR(254) NOT NULL,"email" VARCHAR(254) NOT NULL,"password" VARCHAR(254) NOT NULL,"avatar_url" text NOT NULL,"auth_method" VARCHAR(254) NOT NULL,"oauth1" VARCHAR(254),"oauth2" VARCHAR(254),"passwordInfo" VARCHAR(254),"userprofile_id" BIGINT NOT NULL,"visitor_id" BIGINT NOT NULL,"id" BIGSERIAL NOT NULL PRIMARY KEY);
...
create table if not exists "piecemetrics" ("id" BIGINT NOT NULL PRIMARY KEY,"views" text,"likes" INTEGER NOT NULL,"dislikes" INTEGER NOT NULL);
