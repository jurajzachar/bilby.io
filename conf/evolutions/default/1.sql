...
create table "piece" ("id" BIGSERIAL NOT NULL PRIMARY KEY,"title" VARCHAR(254) NOT NULL,"short_summary" text,"title_cover" text,"published" BIGINT,"author_id" BIGINT NOT NULL,"tags" text,"source" text NOT NULL);
create table "piecemetrics" ("id" BIGINT NOT NULL PRIMARY KEY,"views" text,"likes" INTEGER,"dislikes" INTEGER);
